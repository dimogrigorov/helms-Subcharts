...
module.exports = {
  mongodb: {
   ...
   // ssl: process.env.ME_CONFIG_MONGODB_SSL || true,

    // sslValidate: validate mongod server certificate against CA
    //sslValidate: process.env.ME_CONFIG_MONGODB_SSLVALIDATE || false,
    ...
    // sslCA: array of valid CA certificates
    sslCA: [require('fs').readFileSync(process.env.ME_CONFIG_MONGODB_CA_FILE).toString()],
